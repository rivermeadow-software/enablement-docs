# Migration Methods (DONE)
---
The RiverMeadow platform supports migrating servers to HPE Morpheus VM Essentials utilizing the OS based and VM based migrations methods. The two migration methods support different capabilities such as supported sources, optimization features, modernization features, and more.
...
* **Optimization and modernization support:** Leverage optimization features such as storage rightsizing and modernization features such as OS modernization, SQL modernization, and Linux OS conversion during the migration process.
