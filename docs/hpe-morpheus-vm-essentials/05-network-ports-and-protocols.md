...
|:--------:|:--------:|:-------:|:----------:|:-------:|
| Admin Workstation | RiverMeadow Platform | 443 | TCP | UI and API access for performing migration activities |
...
| RiverMeadow Migration Appliance | Target Server (Linux) | 5994 | TCP | Migration target preparation |
...
| Target Server | Source Server | 5994 | TCP | Data replication from the source server to target server |
...
| Target Server | RiverMeadow Source Worker Appliance | 5994 | TCP | Data replication from the source worker appliance to target server |