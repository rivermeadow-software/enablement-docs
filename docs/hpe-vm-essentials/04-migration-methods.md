...
| **Retain source IP Address** | Keep the IP and MAC address of the source workload | [^1]  |  |
| **Retain source MAC Address** | Keep the IP and MAC address of the source workload | *2 |  |
...
:::info
HPE Morpheus VM Essentials HVM instances do not natively supported specifying a custom MAC address during provisioning.
:::
